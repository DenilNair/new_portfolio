    ...
    <div className='main-nav-div'>
      <nav className='main-nav'>
        ...
        <div className={showMediaIcons ? "menuLink" : "mobileMenuLink"}>
          <ul>
            <li className={currentSection == "home" ? "selectedList" : "notSelectedList"} onClick={() => {
        ...
        <div className='toogleMode' > <button className='sidebar-toggle' onClick={changeIsDarkmode}>
          {isDarkMode && <span><img src={process.env.PUBLIC_URL + "/img/mode-light.svg"} alt='project1' /></span>}
          {!isDarkMode && <span><img src={process.env.PUBLIC_URL + "/img/lighting-display-dark-mode.svg"} alt='project1' /></span>}
